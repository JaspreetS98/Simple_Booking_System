...
public class CommandParser {
	/**
	 * CommandParser translate commands to actual operations which various length of the commands
	 * 
	 * @throws IOException data error
	 * @throws FlightBookingSystemException special error
	 * @param line string with command
	 * @return Command after parse
	 */
	public static Command parse(String line) throws IOException, FlightBookingSystemException {
		try {
			...
			if (cmd.equals("addflight")) {
				...
				double ticketPrice = Double.parseDouble(br.readLine());

				LocalDate departureDate = parseDateWithAttempts(br);
				return new AddFlight(flighNumber, origin, destination, departureDate, capacity, ticketPrice);
